...
final def jenkinsUrl = "http://192.168.27.19:8080/view/Platform%20Trunk"
final def arduinoIp = "192.168.26.231"
final def pins = ['02','03','04'] //g,y,r - order is important

//red has precedence over yellow
final def yellowWhenFailed = 1/10 //one out of ten failed (or more) -> traffic light turns yellow
final def redWhenFailed = 2/10    //two out of ten failed (or more) -> traffic light turns red 

final def checkInterval = 30 * 1000 //every 30 sec

while(true){
  println "Running check on Jenkins for traffic control at [${new Date()}]"
